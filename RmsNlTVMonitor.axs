//*********************************************************************
//
//             AMX Resource Management Suite  (4.6.11)
//
//*********************************************************************
/*
 *  Legal Notice :
...
CHAR MONITOR_ASSET_NAME[]             = 'Display';


// RMS Asset Properties (Optional)
CHAR MONITOR_ASSET_DESCRIPTION[]      = 'Samsung';
CHAR MONITOR_ASSET_MANUFACTURERNAME[] = 'Samsung';
CHAR MONITOR_ASSET_MODELNAME[]        = 'Samsung';
...
#IF_DEFINED HAS_SOURCE_SELECT
    METADATA_PROPERTY_SOURCE_INPUT_COUNT      = 3;
    CHAR METADATA_PROPERTY_SOURCE_INPUT[100]  = 'HDMI 1|HDMI 2|PC';
#END_IF
...
#IF_DEFINED HAS_POWER
    CASE 'asset.power' :
    {
      SWITCH(LOWER_STRING(cValue1))
      {
        CASE 'on'  :
        {
	  DO_PUSH_TIMED (vdvDeviceModule, 2	, 1)
        }
        CASE 'off' :
        {
	  DO_PUSH_TIMED (vdvDeviceModule, 1	, 1)
        }
      }
    }
#END_IF
	...
	SWITCH(cValue1)
	  {
	    CASE 'HDMI 1'  :
	    {
	      DO_PUSH_TIMED (vdvDeviceModule, 3	, 1)
	    }
	    CASE 'HDMI 2' :
	    {
	      DO_PUSH_TIMED (vdvDeviceModule, 4	, 1)
	    }
	    CASE 'PC' :
	    {
	      DO_PUSH_TIMED (vdvDeviceModule, 6	, 1)
	    }	    
	  }
    }
#END_IF
