 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlVideoConferencerMonitor'(DEV vdvRMS,
                                           DEV vdvDeviceModule,
...
#DEFINE HAS_CAMERA_PRESET
#DEFINE HAS_CAMERA_PAN_TILT
...
CHAR MONITOR_ASSET_NAME[]             = 'Video Conferencer';
...
CHAR MONITOR_NAME[]       = 'RMS Video Conferencer Monitor';
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlVidConfMon';
...
#IF_DEFINED HAS_SOURCE_SELECT
    METADATA_PROPERTY_SOURCE_INPUT_COUNT     = 4;
    CHAR METADATA_PROPERTY_SOURCE_INPUT[100] = 'Main Camera|Aux Camera|DVD|PC';
#END_IF

#IF_DEFINED HAS_CAMERA_PRESET
    METADATA_PROPERTY_CAMERA_PRESET_COUNT  = 15;
#END_IF

#IF_DEFINED HAS_CAMERA_PAN_TILT
    SLONG METADATA_PROPERTY_PAN_LVL_INIT   = 0;
    SLONG METADATA_PROPERTY_PAN_LVL_MIN    = 0;
    SLONG METADATA_PROPERTY_PAN_LVL_MAX    = 255;
    SLONG METADATA_PROPERTY_PAN_LVL_RESET  = 0;

    SLONG METADATA_PROPERTY_TILT_LVL_INIT  = 0;
    SLONG METADATA_PROPERTY_TILT_LVL_MIN   = 0;
    SLONG METADATA_PROPERTY_TILT_LVL_MAX   = 255;
    SLONG METADATA_PROPERTY_TILT_LVL_RESET = 0;

    SLONG METADATA_PROPERTY_PAN_SPD_INIT   = 0;
    SLONG METADATA_PROPERTY_PAN_SPD_MIN    = 0;
    SLONG METADATA_PROPERTY_PAN_SPD_MAX    = 255;
    SLONG METADATA_PROPERTY_PAN_SPD_RESET  = 0;

    SLONG METADATA_PROPERTY_TILT_SPD_INIT  = 0;
    SLONG METADATA_PROPERTY_TILT_SPD_MIN   = 0;
    SLONG METADATA_PROPERTY_TILT_SPD_MAX   = 255;
    SLONG METADATA_PROPERTY_TILT_SPD_RESET = 0;
#END_IF
...
#IF_DEFINED HAS_CONFERENCER
    CASE 'conferencer.privacy' :
    {
      SWITCH(nValue1)
      {
        CASE TRUE  :
        {
          PULSE[vdvDeviceModule,VCONF_PRIVACY_ON]
        }
        CASE FALSE :
        {
          IF([vdvDeviceModule,VCONF_PRIVACY_FB])
            PULSE[vdvDeviceModule,VCONF_PRIVACY]
        }
      }
    }
#END_IF
