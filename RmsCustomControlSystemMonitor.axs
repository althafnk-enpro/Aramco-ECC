//*********************************************************************
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 05/07/2019  AT: 06:18:56        *)
(***********************************************************)
//
 ...
 *     as applicable.
*/
MODULE_NAME='RmsCustomControlSystemMonitor'(DEV vdvRMS, DEV dvMonitoredDevice)
...
DEFINE_FUNCTION ExecuteAssetControlMethod(CHAR methodKey[], CHAR arguments[])
{
  ...
  debug("'ExecuteAssetControlMethod(',methodKey,', ',arguments,')'");
